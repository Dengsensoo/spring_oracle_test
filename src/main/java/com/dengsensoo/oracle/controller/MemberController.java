package com.dengsensoo.oracle.controller;
...
import com.dengsensoo.oracle.dao.MemberDao;
...
public class MemberController {
	...
	public String joinOk(HttpServletRequest request, Model model) {		
		...
		int checkFlag = dao.memberidCheckDao(mid); //아이디가 이미 DB에 존재하는지 확인->존재하면 1, 아니면 0
